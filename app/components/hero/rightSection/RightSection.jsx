  ...
  return (
    <>
      <div className="relative mx-auto  grid h-[200px] w-[320px] max-w-[100%] grid-cols-2 gap-0 sm:grid-cols-2  md:grid-cols-2 lg:mr-[100px]">
        <Link href="/events">
          <Image
            src="/community/assets/images/home_page/menu_stickers/events-withshadow.svg"
        ...
        >
          <Image
            src="/community/assets/images/home_page/menu_stickers/studio.svg"
            alt="app"
            height={120}
            width={200}
        ...
        <Link href="/contact">
          <Image
            src="/community/assets/images/home_page/menu_stickers/contact-withshadow.svg"
        ...
        <Link href="/about-community">
          <Image
            src="/community/assets/images/home_page/menu_stickers/community-withshadow.svg"
        ...
        <Link href="/about-kreatr">
          <Image
            src="/community/assets/images/home_page/menu_stickers/about-layerblur.svg"
        ...
        <Image
          ...
          alt="arrow image"
          src="/community/assets/images/home_page/menu_stickers/Arrow.svg"
          height={256}
          width={122}
        />
        <Image
          ...
          alt="arrow image"
          src="/community/assets/images/home_page/menu_stickers/mobile-arrow.svg"
          height={46}
          width={40}
        />
        <Image
          src="/community/assets/images/home_page/menu_stickers/menu-withshadow.svg"
        ...
        />
        <Image
          src="/community/assets/images/home_page/menu_stickers/explorer-withshadow.svg"
