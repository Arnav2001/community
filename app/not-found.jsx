      ...
      <main className="bg-img fixed h-[100%] bg-contain pt-[6.25rem] ">
        ...
        <div className="container mx-auto mb-[6.25rem]  sm:mt-[100px] lg:mt-[60px]">
          <div className=" mt-[3rem] grid grid-cols-1 sm:grid-cols-5 md:grid-cols-5 lg:ml-4">
            <div className="order-2 mt-[4.125rem] flex flex-col items-center justify-center sm:order-1 sm:col-span-1 sm:mb-[70px] sm:ml-[20px] sm:mt-[196px] sm:items-start md:mb-[4.75rem] md:ml-[3.125rem]  md:mr-[-4.6875rem] md:mt-[11.75rem] lg:ml-[8.125rem] lg:mr-[-4.6875rem] lg:mt-[220px] xl:ml-[6.125rem] xl:mt-[25.3125rem]">
              <h1 className="error-page mx-auto flex flex-col items-center text-center text-[1.25rem] font-semibold leading-[20px]  sm:mx-0 sm:mr-[-55px] sm:block  sm:text-start sm:leading-5 md:leading-5 lg:text-[30px] lg:leading-8 xl:text-[2.5rem] xl:leading-[2.8125rem]">
                Sometimes things
                <br className="hidden sm:block" /> go missing
                <br />
                and that’s okay :)
              </h1>
              <Link
